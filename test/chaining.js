...
(function() {
  $(document).ready(function() {
    var collections, i, len, listenToChain, models, name, names, noEvents, testEvent;
    if (!window.console) {
      window.console = {};
    ...
    QUnit.test("event map", 7, function() {
      return testEvent({
        model: models.a,
        event: {
          nonchain: function() {
          ...
          "nonchain-mixed single-mixed@chain double-mixed@chain.chain": function() {
            return ok(true, "got mixed event");
          }
        },
        trigger: function() {
          models.a.trigger("nonchain");
          ...
          return models.c.trigger("double-mixed");
        }
      });
    });
