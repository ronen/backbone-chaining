...
(function() {
  $(document).ready(function() {
    var collections, genericListener, models, name, names, noEvents, testEvent, _i, _len;
    if (!window.console) {
      window.console = {};
    ...
    noEvents = function() {
      return ok(_.all(_.toArray(models).concat(_.toArray(collections).concat(_.toArray(genericListener), function(sender) {
    ...
    QUnit.test("listenTo chain", 2, function() {
      models.item0.listenTo(models.a, "sample@chain.chain", function() {
        return ok(true, "got sample@chain.chain");
      });
    ...
    QUnit.test("generic listener object listenTo", 2, function() {
      genericListener.listenTo(models.a, "sample@chain.chain", function() {
        return ok(true, "got sample@chain.chain");
      });
      models.c.trigger("sample");
